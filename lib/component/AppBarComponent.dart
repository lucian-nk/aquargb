...
class AppBarComponentState extends State<AppBarComponent> {
  ...
  Widget mAppBarLeft() {
    ...
    } else if (getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_TAB_BAR || getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_BOTTOM_NAVIGATION) {
      return SizedBox();
    } else {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      leadingWidth: getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_TAB_BAR || getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_BOTTOM_NAVIGATION ? 16 : 50,
